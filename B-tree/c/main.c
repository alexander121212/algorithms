...
struct btree_node_ops btn_ops;
struct btree_ops bt_ops;


void btree_node_traverse(struct btree_node_t *self)
{
	int i = 0;
...
struct btree_node_t* btree_node_search(struct btree_node_t *self, int k)
{
	int i = 0;
...
int btree_node_find_greater_or_equal(struct btree_node_t *self, int k)
{
	int idx = 0;
...
void remove_from_leaf(struct btree_node_t *self, int idx)
{
...
int get_predecessor(struct btree_node_t *self, int idx)
{
...
int get_successor(struct btree_node_t *self, int idx)
{
	struct btree_node_t *cur = self->children[idx+1];
...
void borrow_from_previous(struct btree_node_t *self, int idx)
{
...
void borrow_from_next(struct btree_node_t *self, int idx)
{
...
void merge_children(struct btree_node_t *self, int idx)
{
	struct btree_node_t *child = self->children[idx];
	struct btree_node_t *sibling = self->children[idx+1];
...
void fill(struct btree_node_t *self, int idx)
{
...
void remove_from_non_leaf(struct btree_node_t *self, int idx)
{
	int k = self->keys[idx];
...
void btree_node_remove(struct btree_node_t *self, int k)
{
...
struct btree_node_t *btree_node_ctr(int degree, bool leaf)
{
...
void split_child(struct btree_node_t *self, int position, struct btree_node_t *splited_node)
{
...
void insert_not_full(struct btree_node_t *self, int k)
{
...
void btree_node_dtor(struct btree_node_t *self)
{
	printf("[%s] \n", __func__);
	return;
}
